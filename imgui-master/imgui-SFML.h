...
// ImageButton overloads
    ...
    bool ImageAnimButton(const sf::Texture& texture, const sf::Texture& texture2, const int framePadding = -1,
                     const sf::Color& bgColor = sf::Color::Transparent,
                     const sf::Color& tintColor = sf::Color::White);
    bool ImageAnimButton(const sf::Texture& texture, const sf::Texture& texture2, const sf::Vector2f& size, const int framePadding = -1,
                     const sf::Color& bgColor = sf::Color::Transparent, const sf::Color& tintColor = sf::Color::White);

    bool ImageAnimButton(const sf::Sprite& sprite, const sf::Sprite& sprite2, const int framePadding = -1,
                     const sf::Color& bgColor = sf::Color::Transparent,
                     const sf::Color& tintColor = sf::Color::White);
    bool ImageAnimButton(const sf::Sprite& sprite, const sf::Sprite& sprite2, const sf::Vector2f& size, const int framePadding = -1,
                     const sf::Color& bgColor = sf::Color::Transparent,
                     const sf::Color& tintColor = sf::Color::White);
